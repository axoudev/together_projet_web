...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(User::class, 'rating', 'rater_user_id', 'rated_user_id')->withPivot('rate')->withTimestamps();
    }

    public function raterUsers()
    {
        return $this->belongsToMany(User::class, 'rating', 'rated_user_id', 'rater_user_id')->withPivot('rate')->withTimestamps();
    }
}
